...
class OneNearestNeighbor(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X, y):
        """Initialises the classes and the neigbors from the given data.
    ...
    def predict(self, X):
        """Predicts the class label for the given data.
        ...
        compd = lambda q: ((self.X_ - q)**2).sum(axis=1)
    ...
    def score(self, X, y):
        """Computes mean accuracy for the given data.
