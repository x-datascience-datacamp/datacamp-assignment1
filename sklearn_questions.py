...
class OneNearestNeighbor(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X, y):
        ...
        if len(self.classes_) > 50:
            raise ValueError("Unknown label type: Too many classes for it to be a classification problem!")
        self.data_ = X
        self.labels_ = y
        return self
    ...
    def score(self, X, y):
        """Write docstring
            Validates the model by comparing the ground truth classes
            with the predicted classes by our model
